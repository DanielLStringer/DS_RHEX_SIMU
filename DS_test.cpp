...
#include <iostream>
#include <cstdlib>
#include <rhex_dart/DS_rhex_dart_simu.hpp>
#define CTRL_SIZE 28
...
//std::cout<<std::string(std::getenv("RESIBOTS_DIR")) + "/share/rhex_models/SKEL/" + argv[3]<<std::endl;
...
//////////// ./waf && ./build/test_damage 0 1 raised.skel 
    ...
    using desc_t = boost::fusion::vector<rhex_dart::descriptors::DutyCycle,
     ...
     rhex_dart::DSRhexDARTSimu<rhex_dart::desc<desc_t>, rhex_dart::viz<viz_t>> simu( global_robot, atof(argv[1]), atof(argv[2]));
